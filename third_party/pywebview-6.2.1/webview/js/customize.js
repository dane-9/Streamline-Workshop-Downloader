...
(function() {
    ...
    function disableTouchEvents() {
        ...
        function onMouseDown(ev) {
            ...
            // Qt/Wayland does not allow clients to position top-level windows.
            // Ask Qt to start a compositor-managed interactive move instead of
            // feeding absolute coordinates to Window.move(). This also keeps
            // native snapping and tiling behavior on X11.
            if (platform === 'qtwebengine' || platform === 'qtwebkit') {
                window.pywebview._jsApiCallback('pywebviewStartSystemMove', [], 'move');
                return;
            }
